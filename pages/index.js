...
<div className="anim" style={{ fontSize: 52, marginBottom: 12 }}><img src="/logo-fsspx.png" style={{width:80,height:80,objectFit:'contain'}} /></div>        <h1 className="anim stagger-2 display gold-text" style={{ fontSize: 'clamp(28px,6vw,52px)', fontWeight: 700, lineHeight: 1.1, marginBottom: 16 }}>{CONFIG.title}</h1>
