...
const CONFIG = {
  title: 'Rifa para o Terreno da FSSPX em Penha',
  ...
  if (step === 'home') return (
    <div style={{ minHeight: '100vh', background: 'var(--navy)' }}>
      ...
      <div style={{ background: 'linear-gradient(180deg,#0a1525 0%,var(--navy) 80%)', borderBottom: '1px solid rgba(201,153,58,0.2)', padding: '44px 20px 36px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="anim" style={{ fontSize: 52, marginBottom: 12 }}><img src="/logo-fsspx1.png" style={{width:80,height:80,objectFit:'contain'}} /></div>
